...
#if !defined(PM_CPUNET_B0N_CONTAINER_ID)
...
#define PM_CPUNET_B0N_CONTAINER_ID 14
#define PM_CPUNET_b0n_container_ID PM_B0N_CONTAINER_ID
#define PM_CPUNET_b0n_container_IS_ENABLED 1
#define PM_14_LABEL CPUNET_B0N_CONTAINER
#endif // !defined(PM_CPUNET_B0N_CONTAINER_ID)
